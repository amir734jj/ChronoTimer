...
public class testClr {
	...
	public void testTriggrtClr() {
		...
		assertTrue(RaceCollection.isExistByRacerID(122));
		Clr.triggrtClr(122);
		assertFalse(RaceCollection.isExistByRacerID(122));
		assertTrue(RaceCollection.floatingRacers.contains(test2));
	}
